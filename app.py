    ...
    "기본": {
        ...
        "📋 기본 종합": [
            ...
            {"id": "z06", "type": "mc", "category": "②+③",
             "question": "온톨로지 Cold Start에서 'AI 80% 초안'이 가능한 이유와 기존 인프라의 관계는?",
             "options": ["A) AI가 비즈니스 도메인을 미리 학습했기 때문", "B) Pipeline Builder로 연결된 기존 데이터 구조를 AI가 분석해 Object·Link 초안을 빠르게 생성할 수 있기 때문", "C) 컨설턴트가 사전에 설계해 두기 때문", "D) 표준 온톨로지 템플릿이 있기 때문"],
             "answer": "B",
             "explanation": "Pipeline Builder가 기존 ERP·CRM 데이터를 연결하면, AI가 기존 테이블 구조를 분석해 Object·Link 초안의 80%를 빠르게 생성합니다. 기존 인프라가 있기 때문에 Cold Start가 빠른 이유입니다."},
